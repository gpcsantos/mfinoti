...
<?php
  ...
  if(isset($_GET["submit"])){
    if(base64_decode($_GET['submit'])=='alterar'){
      ...
      $sql = "SELECT * FROM tb_banco WHERE pk_id=".$id;
  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Novo Banco</h6>
      ...
      <!-- Card Body -->
      <div class="card-body">
      <form class="user" action="banco_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_banco" name="txt_banco" value="<?php echo $row->banco; ?>" placeholder="Nome do banco" required>
                </div>
                <div class="col-sm-6">
                  <input type="number" class="form-control form-control-lg" id="txt_num" name="txt_num" value="<?php echo $row->num; ?>" placeholder="Número do banco" required>
