      ...
      <form class="user" action="banco_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_banco" name="txt_banco" placeholder="Nome do banco" required>
                </div>
                <div class="col-sm-6">
                  <input type="number" class="form-control form-control-lg" id="txt_num" name="txt_num" placeholder="Número do banco" required>
                </div>
              </div>
