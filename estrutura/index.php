                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <a href="pagina.php" class="btn btn-primary btn-icon-split btn-lg">
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                      <a href="perfil.php" class="btn btn-primary btn-icon-split btn-lg">
                        <span class="icon text-white-50">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <a href="perfil_arquivo.php" class="btn btn-primary btn-icon-split btn-lg">
                        ...
                        <span class="text">Perfil X Arquivo</span>
                      </a>
                      </div>
