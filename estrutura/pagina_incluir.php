  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Nova página</h6>
      ...
      <form class="user" action="pagina_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_arquivo" name="txt_arquivo" placeholder="caminho/nome_do_arquivo" required>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_descricao" name="txt_descricao" placeholder="Descrição" required>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 mb-6 mb-sm-0 text-center ">
                <hr />
                  <p class="bg-gradient-dark text-gray-100">Informe a baixo, quais ações para o novo arquivo:</p>
                </div>
              </div>
              <div class="form-group row">
