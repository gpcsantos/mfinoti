  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Novo perfil</h6>
      ...
      <form class="user" action="perfil_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_perfil" name="txt_perfil" placeholder="Digite o nome do novo perfil" required>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_abreviado" name="txt_abreviado" placeholder="Abreviação" required>
                </div>
              </div>
