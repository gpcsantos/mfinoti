<?php
  ...
  if(isset($_GET["submit"])){
    if(base64_decode($_GET['submit'])=='alterar'){
      ...
      $sql = "SELECT * FROM tb_usuario WHERE pk_id=".$id;
        ...
        <form class="user" action="usuario_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_login" name="txt_login" value="<?php echo $row->login; ?>" placeholder="Informe o login (usuário)" required>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <hr />
                  caso não queira mudar a senha, mantenha os campos da senha vazios!
                </div>
              </div>
              
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="password" class="form-control form-control-lg" id="txt_senha" name="txt_senha" placeholder="Informe a senha">
                </div>
                <div class="col-sm-6">
                  <input type="password" class="form-control form-control-lg" id="txt_senha2" name="txt_senha2" placeholder="Confirme a senha">
                  ...
                  <select class="form-control form-control-lg" name="cbo_acesso" required>
                      ...
                      <?php
                        ...
                        while($row1=mysqli_fetch_object($result1)){
                            $chk = ($row1->pk_id==$row->fk_perfil ? "selected" : "");
                      ?>
                           <option value="<?php echo $row1->pk_id; ?>" <?php echo $chk; ?>><?php echo $row1->perfil; ?></option>
                      <?php
                        }
                      ?>
                  </select>
