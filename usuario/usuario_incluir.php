...
<div class="row">
  ...
  <div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
      ...
      <!-- Card Body -->
      <div class="card-body">
      <form class="user" action="usuario_salvar.php" method="POST">
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-lg" id="txt_login" name="txt_login" placeholder="Informe o login (usuário)" required>
                </div>
                
              </div>
              <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="password" class="form-control form-control-lg" id="txt_senha" name="txt_senha" placeholder="Informe a senha" required>
                </div>
                <div class="col-sm-6">
                  <input type="password" class="form-control form-control-lg" id="txt_senha2" name="txt_senha2" placeholder="Confirme a senha" required>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-12 mb-3 mb-sm-0">
                  <select class="form-control form-control-lg" name="cbo_acesso" required>
                      <option value="">-- Selecione um perfil de acesso para o usuário --</option>
                      <?php
                        $sql = "SELECT * FROM tb_perfil ORDER BY perfil";
                        $result = mysqli_query($con,$sql);
                        while($row=mysqli_fetch_object($result)){
                      ?>
                           <option value="<?php echo $row->pk_id ;?>"><?php echo $row->perfil ;?></option>
                      <?php
                        }
                      ?>
                  </select>
              ...
              <div class="form-group row">
                ...
                <hr />
                  <p class="bg-gradient-dark text-gray-100">Informe a baixo, quais opções estarão liberadas para o usuário:</p>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-3 mb-3 mb-sm-0 text-center" >
                  <label for="chk1">
                    ...
                    <input type="checkbox" id="chk1" name="chk1"  class="btn btn-primary"/>
                  </label>
                </div>
                <div class="col-sm-3 text-center">
                  <label for="chk2">
                    Read (ler informações)<br>
                    <input type="checkbox" id="chk2" name="chk2" class="btn btn-primary"/>
                  </label>
                </div>
                <div class="col-sm-3 text-center">
                  <label for="chk3">
                    Update (alterar informações)<br>
                    <input type="checkbox" id="chk3" name="chk3" class="btn btn-primary"/>
                  </label>
                </div>
                <div class="col-sm-3 text-center">
                  <label for="chk4">
                    Delete (apagar informações)<br>
                    <input type="checkbox" id="chk4" name="chk4" class="btn btn-primary"/>
                      </label>
                </div>
              </div>
